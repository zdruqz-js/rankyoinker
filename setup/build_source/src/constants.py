...
DEFAULT_CONFIG = {
    ...
    "weapon": "Vandal",
    "chat_limit": 5,
    # RankYoinker: Sprache fuer Discord Rich Presence (src/rpc.py). Wird vom
    # Browser ueber vry_log_server.py's /api/set-lang in config.json
    # geschrieben - hier nur als Default fuer den Fall, dass config.json
    # (noch) keinen eigenen Wert hat.
    "lang": "de",
    "table": {
        "skin": True,
        "rr": True,
