...
try:
    ...
    def prefetch_players_rank_and_stats(players, current_match_id):
        ...
        warten. Die Overlay-Seite bekommt bewusst erst am Ende die komplette
        Liste auf einen Schlag, nicht Spieler fuer Spieler waehrenddessen.
        """
        ...
        if True:
            ...
            if game_state == "INGAME":
                ...
                with richConsole.status("Loading Players...") as status:
                    ...
                    # gecachte Werte. Bewusst KEIN Zwischenstand an die
                    # Overlay-Seite, bevor wirklich alle fertig sind - Nutzer
                    # wollten lieber die komplette, fertige Liste auf einen
                    # Schlag sehen statt einzelne Spieler nach und nach
                    # reinpoppen zu sehen.
                ...
                with richConsole.status("Loading Players...") as status:
                    ...
                    # Bewusst kein Zwischenstand fuer die Overlay-Seite (siehe
                    # INGAME weiter oben fuer die Begruendung) - komplette
                    # Liste auf einen Schlag statt einzelner Spieler nach und
                    # nach.
                    status.update("Loading Players...")
